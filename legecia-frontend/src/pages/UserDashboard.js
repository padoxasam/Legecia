  ...
  return (
    <div style={{ minHeight: "100vh", background: "#05040a", color: "#00ffff" }}>
      ...
      <div style={{ padding: "30px" }}>
        <h2 style={{ letterSpacing: "2px" }}>USER DASHBOARD</h2>

        <div style={{ display: "flex", gap: "20px", marginTop: "30px" }}>
          <DashboardCard
            title="Create Supervision"
            description="Create a new supervision request for a package"
          />

          <DashboardCard
            title="My Supervisions"
            description="View draft, pending, and approved supervisions"
          />
        </div>
      </div>
    </div>
